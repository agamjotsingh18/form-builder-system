import {
  require_jsx_runtime
} from "./chunk-BWKKOG7S.js";
import {
  __commonJS,
  __toESM,
  require_react
} from "./chunk-PME7333U.js";
...
// node_modules/@tanstack/react-form/dist/esm/useForm.js
var import_rehackt3 = __toESM(require_rehackt(), 1);

// node_modules/@tanstack/react-form/dist/esm/useField.js
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var import_rehackt2 = __toESM(require_rehackt(), 1);

// node_modules/@tanstack/react-form/dist/esm/useIsomorphicLayoutEffect.js
var import_rehackt = __toESM(require_rehackt(), 1);
var useIsomorphicLayoutEffect = (
  // @ts-ignore
  typeof window !== "undefined" ? import_rehackt.useLayoutEffect : import_rehackt.useEffect
);

// node_modules/@tanstack/react-form/dist/esm/useField.js
function useField(opts) {
  const [fieldApi] = (0, import_rehackt2.useState)(() => {
...
function useForm(opts) {
  const [formApi] = (0, import_rehackt3.useState)(() => {
...
// node_modules/decode-formdata/dist/index.js
var DIGIT_REGEX = /^\d+$/u;
...
function getFieldValue(info, templateName, value) {
  var _a, _b, _c;
  if ((_a = info == null ? void 0 : info.booleans) == null ? void 0 : _a.includes(templateName)) {
    return value !== "false" && value !== "0";
  }
  if (typeof value === "string") {
    if ((_b = info == null ? void 0 : info.dates) == null ? void 0 : _b.includes(templateName)) {
      return getFieldDate(value);
    }
    if ((_c = info == null ? void 0 : info.numbers) == null ? void 0 : _c.includes(templateName)) {
...
function decode(formData, info) {
  ...
  for (const [path, value] of formData.entries()) {
    ...
    path.split(".").reduce((object, key, index, keys) => {
      ...
      if (index < keys.length - 1) {
        ...
        const isArray = index < keys.length - 2 ? templateKeys[index + 1] === "$" : (_a = info == null ? void 0 : info.arrays) == null ? void 0 : _a.includes(templateKeys.slice(0, -1).join("."));
        return object[key] = isArray ? [] : {};
      }
      if (!((_b = info == null ? void 0 : info.files) == null ? void 0 : _b.includes(templateName)) || value && (typeof value === "string" || value.size)) {
        object[key] = getFieldValue(info, templateName, value);
      }
    }, values);
  }
  if (info == null ? void 0 : info.arrays) {
  ...
  if (info == null ? void 0 : info.booleans) {
...
// node_modules/@tanstack/react-form/dist/esm/validateFormData.js
var getValidateFormData = (defaultOpts) => async (formData, info) => {
...
// node_modules/@tanstack/react-form/dist/esm/createFormFactory.js
